...
function formsummit() {
    const selectedFile = document.getElementById('pid').files[0];
    ...
    reader.onload = function (event) {
        ...
        let printContent = `
            ...
            <body>
                <div class="container">
                    <div class="start">
                        <h2 class="name">${fnmae} ${lname}</h2>
                        <img class="img" src="${event.target.result}" alt="Uploaded Image">
                    </div>
                    <div class="container1">
                        <h3 class="info">Contact Info :</h3>
                        <p class="info">Address: ${address}<br>Email: ${email}<br>Phone: ${pnum}<br>LinkedIn: ${linkdin}<br>Github: ${git}</p>
                        <hr>
                        <h3 class="info">Career Objective</h3>
                        <p class="info">${carrier}</p>
                        <hr>
                        <h3 class="info">Educational Qualification</h3>
                        <table border="1px" class="info" id="table" >
            <tr>
            ...
            <tr>
                ...
                <td>${cgpa2}</td>
                    ...
                    <div class="container2">
                        <h3 class="info">Soft Skills</h3>
                        <ul>
                            <li>${sskills}</li>
                            <li>${sskills1}</li>
                        </ul>
                        <h3 class="info">Technical Skills</h3>
                        <ul>
                            <li>${tskills}</li>
                            <li>${tskills1}</li>
                        </ul>
